...
const STATUS_OPTIONS = [
  ...
  { value: "COMPLETED", label: "Đã học xong" },
];
    ...
    <div style={{ marginTop: 24 }}>
      ...
      <div style={cardStyle}>
        ...
        <p style={{ fontSize: 14, color: "#6b7280", marginBottom: 16 }}>
          Học viên mới đăng ký sẽ có trạng thái <b>NEW</b>. Sau khi xếp lớp
          hoặc kết thúc khoá bạn có thể đổi sang <b>ACTIVE</b> /{" "}
          <b>COMPLETED</b> ở bảng phía dưới.
        </p>
      ...
      <div style={{ ...cardStyle, marginTop: 32 }}>
        ...
        <p style={{ fontSize: 14, color: "#6b7280", marginBottom: 16 }}>
          Use case: <b>Học viên đăng ký mới / đang học / đã học</b>. Bạn có thể
          sửa thông tin và đổi trạng thái học viên tại đây.
        </p>
