...
export default function MockExamPanel() {
  ...
  // ====== STATE CHI TIẾT KỲ THI / ĐIỂM THI ======
  ...
  // Gọi API lấy toàn bộ kết quả thi thử / đăng ký của học viên
  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: 14, color: "#555", marginBottom: 16 }}>
        Giảng viên có thể xem danh sách kỳ thi thử mà học viên đã đăng ký, lọc
        theo kỳ thi, ngày thi, trạng thái (đã thi / đang thi / sắp thi) và học
        viên. Nếu kỳ thi đã diễn ra thì hiển thị điểm, nếu chưa thi thì chỉ xem
        lịch thi.
      </p>
            ...
            {filteredResults.map((r, idx) => (
              <tr key={r.id}>
                ...
                <td style={tdStyle}>
                  ...
                  >
                    {r.status === "FINISHED" ? "Xem điểm" : "Xem lịch thi"}
                  </button>
                </td>
              </tr>
            ))}
        ...
        >
          ...
          {selectedResult.status === "FINISHED" ? (
            <>
              ...
              <p>
                <b>Ghi chú:</b>{" "}
                {selectedResult.feedback || "Không có ghi chú"}
              </p>
            </>
          ) : (
            <>
              ...
              <p>
                <b>Phòng thi:</b>{" "}
                {selectedResult.room || "Chưa có thông tin"}
              </p>
              <p>
                <i>
                  Kỳ thi này chưa có điểm. Giảng viên chỉ xem lịch thi và danh
