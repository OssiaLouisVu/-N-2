...
export default function MockExamPanel() {
  ...
  >
    ...
    {selectedResult.status === "FINISHED" ? (
      // ===== TRƯỜNG HỢP ĐÃ THI -> HIỂN THỊ ĐIỂM =====
      <>
        <p>
      ...
      // ===== TRƯỜNG HỢP ĐANG THI / SẮP THI -> HIỂN THỊ LỊCH =====
      <>
        <p>
          <b>Giờ thi:</b>{" "}
        ...
        <p>
          <b>Phòng thi:</b> {selectedResult.room || "Chưa có thông tin"}
        </p>
        <p>
          <i>
            Kỳ thi này chưa có điểm. Giảng viên chỉ xem lịch thi và danh sách học
            viên đăng ký.
          </i>
        </p>
      </>
