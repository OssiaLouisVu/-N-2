...
// lọc theo ngày thi (so sánh chuẩn hoá theo dd/mm hoặc yyyy-mm-dd)
if (date) {
  const filterDateKey = normalizeDateStr(date);      // từ input type="date" (2025-06-01)
  const itemKey = normalizeDateStr(r.date);          // từ backend: "1/6/2025" hoặc "2025-06-01"
  if (!itemKey || itemKey !== filterDateKey) {
    return false;
  }
}
