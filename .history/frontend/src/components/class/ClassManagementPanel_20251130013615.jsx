...
export default function ClassManagementPanel({ refreshToken = 0 }) {
  ...
  useEffect(() => { load(); }, []);
  // reload when parent signals refresh (e.g., new student created)
        ...
        <>
          ...
          {selectedClassId && (
            <div style={{ marginTop: 16 }}>
              <ClassDetail classId={selectedClassId} refreshToken={refreshToken} onDone={() => { setSelectedClassId(null); load(); }} />
            </div>
          )}
        </>
      )}
