  ...
  return (
    ...
    >
      ...
      >
        Đăng xuất
        <button
          className={`px-8 py-4 rounded-full text-lg font-semibold focus:outline-none transition-all duration-200 ${activeTab === 'class' ? 'bg-indigo-500 text-white shadow-lg' : 'bg-indigo-50 text-indigo-700'}`}
