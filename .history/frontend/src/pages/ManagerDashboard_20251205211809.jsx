  ...
  async function loadMonthly() {
    ...
    try {
      ...
      if (data.success) {
        ...
        console.log('Month daily index:', arr); // Debug log
            ...
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 8,
                  border: "none",
                  background: tab === 'courses'
                    ? "linear-gradient(135deg, #34d399 0%, #10b981 100%)"
                    : "#e0e0e0",
                  color: tab === 'courses' ? "#fff" : "#333",
                  cursor: "pointer",
                  fontWeight: 600,
                  boxShadow: tab === 'courses' ? "0 4px 12px rgba(16,185,129,0.4)" : "none",
                  transition: "all 0.3s",
                  fontSize: 14,
                }}
                onMouseOver={(e) => {
      ...
      <div>
            ...
            {tab === 'courses' && (
              <div className="w-full">
                <h2 className="text-lg font-semibold mb-3">Khoá học</h2>
