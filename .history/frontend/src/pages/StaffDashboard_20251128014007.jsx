...
function StaffDashboard() {
  ...
  return (
    <div style={{ padding: 32 }}>
      ...
      {/* KHU VỰC CHỨC NĂNG (GIỐNG TEACHER DASHBOARD) */}
      <section style={{ marginBottom: 24 }}>
        ...
        <button
          ...
          style={{
            ...
            fontSize: 14,
            background:
              showStudentManagement ? "linear-gradient(90deg,#4c6fff,#9b5cff)" : "#f1f2f6",
      ...
      {/* KHU VỰC "QUẢN LÝ HỌC VIÊN" – CHỈ HIỆN KHI ĐANG BẬT */}
      {showStudentManagement && (
        ...
        >
          ...
          {/* Đây chính là use case "Học viên đăng ký mới" + cấp tài khoản + tìm kiếm, cập nhật */}
          <AddStudentPanel />
        </section>
      )}
    </div>
