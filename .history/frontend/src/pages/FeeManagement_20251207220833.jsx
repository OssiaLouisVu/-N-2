    ...
    <div style={{ minHeight: '100vh', background: '#f5f7fa', paddingBottom: 40 }}>
      <div style={{ background: 'linear-gradient(135deg, #667eea, #764ba2)', color: '#fff', padding: '20px', marginBottom: 30 }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: 10 }}>
            <button onClick={() => navigate('/accountant/report')} style={{ padding: '8px 16px', background: '#10b981', border: 'none', color: '#fff', cursor: 'pointer', borderRadius: 6, fontWeight: 600 }}>📊 Xem Báo Cáo</button>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 20px' }}>
        <div style={{ display: 'flex', gap: 10, marginBottom: 20, justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: 10 }}>
            <button onClick={() => navigate('/accountant/report')} style={{ padding: '10px 20px', background: '#fff', color: '#667eea', border: '1px solid #667eea', cursor: 'pointer', borderRadius: 6, fontWeight: 600 }}>📊 Xem Báo Cáo</button>
            <button onClick={() => navigate('/accountant/inquiry')} style={{ padding: '10px 20px', background: '#10b981', color: '#fff', border: 'none', cursor: 'pointer', borderRadius: 6, fontWeight: 600 }}>🔍 Tra Cứu</button>
            <button onClick={() => navigate('/accountant/notification')} style={{ padding: '10px 20px', background: '#f59e0b', color: '#fff', border: 'none', cursor: 'pointer', borderRadius: 6, fontWeight: 600 }}>📧 Gửi Thông Báo</button>
          </div>
        </div>
