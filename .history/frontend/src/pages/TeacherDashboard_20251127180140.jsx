      ...
      >
        ...
        <div style={{ marginTop: 24, marginBottom: 24, clear: "both" }}>
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            ...
            >
              {showClasses ? "📍 Đóng danh sách lớp" : "📚 Xem danh sách lớp học"}
            </button>
        ...
        {showClasses && (
          <div style={{ marginTop: 30 }}>
            ...
            <div style={{ background: "#fff", borderRadius: 12, padding: 16, boxShadow: "0 2px 8px rgba(0,0,0,0.08)", marginBottom: 24 }}>
            ...
            {(searchType === "UPCOMING" || searchType === "ALL") && (
              <>
                <h3 style={{ marginTop: 24, fontSize: 18, fontWeight: 700, color: "#333" }}>
                  🚀 Lớp học sắp dạy
                </h3>
                <div style={{ background: "#fff", borderRadius: 12, padding: 16, boxShadow: "0 2px 8px rgba(0,0,0,0.08)", marginBottom: 24 }}>
                <table style={tableStyle}>
