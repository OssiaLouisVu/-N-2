...
(async function(){
  ...
  // some installations may not have created_at in users table
  const [users] = await pool.query("SELECT id, username, role, student_id FROM users ORDER BY id ASC LIMIT 50");
