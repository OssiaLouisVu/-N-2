...
// ==================================================================
// HỌC VIÊN ĐÃ HỌC (status = 'COMPLETED')
// GET /api/students/completed?keyword=...
// ==================================================================
router.get("/completed", async(req, res) => {
    ...
    try {
      ...
      `, [kw, kw, kw]
        ...
        console.error("Error GET /api/students/completed", err);
        return res.status(500).json({
            success: false,
            message: "Lỗi máy chủ khi lấy danh sách học viên đã học.",
        });
    }
});
